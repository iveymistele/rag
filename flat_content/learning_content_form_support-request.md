...
<div>
  ...
  <div class="form-item form-group form-item form-type-select form-group" style="margin-bottom:1.6rem;">
    ...
    <div id="rivanna-help" style="font-size:90%;" class="form-text text-muted">Use this form for general Rivanna support questions. Or submit an <a href="/userinfo/hpc/access/#allocation-types" style="font-weight:bold;">Allocation Request</a>.</div>
